...
- Análise léxica com Flex (tokens principais, comentários, espaços, strings e char).
- Ações sintáticas iniciais no parser para preparar geração da AST.
...
- Interpretação completa da AST.
- Analisador semântico

## Recorte proposto da linguagem C para a entrega final

- Tipos básicos: inteiro, float, booleano, char e string.
- Atribuição em variáveis.
- Expressões aritméticas.
- Comparações simples com if/else.
- Switch case
...
2. o parser validar a gramática do recorte com testes manuais ou automatizados,
